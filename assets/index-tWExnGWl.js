...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:{name:e,email:t,body:i}})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e})," by"," ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${t}`,children:t})]}),B.jsx("div",{className:"CommentInfo__body",children:i})]}),Lc=({comments:e=[]})=>B.jsx("div",{className:"CommentList",children:e.length>0?e.map(({id:t,...i})=>B.jsx(Pc,{comment:i},t)):B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})}),Tc=({user:{email:e,name:t}})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e}`,children:t}),Mc=({post:{title:e,user:t,body:i,comments:n}})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("header",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e}),B.jsxs("p",{children:[" Posted by ",B.jsx(Tc,{user:t})]})]}),B.jsx("p",{className:"PostInfo__body",children:i}),B.jsx(Lc,{comments:n})]}),Rc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(({id:t,...i})=>B.jsx(Mc,{post:i},t))});function Dc(e){return Nc.find(({id:t})=>t===e)||null}function jc(e){return zc.filter(({postId:t})=>t===e)}const Oc=Cc.map(({userId:e,id:t,...i})=>({...i,user:Dc(e),comments:jc(t)})),Fc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(B.jsx(Fc,{}));
